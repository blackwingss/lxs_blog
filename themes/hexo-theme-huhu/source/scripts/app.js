require([
  ...
  $(document).ready(function () {
    ...
    $(document).on("click", ".menu-icon", function () {
      $("#menu-mask").removeClass("hide").toggleClass("showMenuMask").toggleClass("hideMenuMask");
    ...
    $(document).on("click", ".icon-toc", function () {
      $("#post-toc").removeClass("hide").toggleClass("showToc").toggleClass("hiddenToc");
    });

    // search
    $(document).on("click", ".search-box", function () {
      $("#search-shade").removeClass("hide").toggleClass("showSearch").toggleClass("hiddenSearch");
      $("body").toggleClass("overflow");
